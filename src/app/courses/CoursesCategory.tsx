  ...
  return (
    <div className="container py-20 px-20">
      <div className="courses-wrapper grid grid-cols-4 gap-10">
        <div className="courses-item border border-inherit rounded-3xl duration-500 hover:-translate-y-1 hover:border-blue-400  p-8">
          ...
          <h2 className="font-semibold text-lg ">Development</h2>
          <span className="text-sm text-gray-400 ">15 Courses</span>
        </div>
        <div className="courses-item border border-inherit rounded-3xl duration-500 hover:-translate-y-1 hover:border-blue-400  p-8">
          <span className="bg-[#A3D6C2] inline-block p-4 rounded-lg text-black text-3xl mb-7 ">
            <svg
        ...
        <div className="courses-item border border-inherit rounded-3xl duration-500 hover:-translate-y-1 hover:border-blue-400  p-8">
          ...
          <h2 className="font-semibold text-lg ">Development</h2>
          <span className="text-sm text-gray-400 ">15 Courses</span>
        </div> <div className="courses-item border border-inherit rounded-3xl duration-500 hover:-translate-y-1 hover:border-blue-400  p-8">
          <span className="bg-[#A3D6C2] inline-block p-4 rounded-lg text-black text-3xl mb-7 ">
            <svg
              width="16"
              height="16"
