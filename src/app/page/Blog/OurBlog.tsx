...
import img5 from "../../../assets/images/breadcrumb-bg.jpg"

const OurBlog: React.FC = () => {
  return (
    <>
      <div
        className="bg-cover bg-center h-[200px] relative flex items-center"
        style={{ backgroundImage: img5.src }}
      >
        <div className="container">
          <div className="text-secondary text-lg flex items-center">
      ...
      <div className="container flex my-32 gap-28">
        ...
        <div className="w-2/3">
          ...
          {/* Quote box */}
          <section className="flex bg-[#DFF9F0] h-[315px] relative rounded-3xl my-10 px-12 py-7">
            <div className="pr-6">
              <svg
                width="44"
                height="40"
          ...
          {/* Promo box */}
          <section className="flex justify-center relative items-center bg-[#FFE2DB] p-14 my-16 rounded-3xl">
            <svg
              width="34"
              height="34"
              viewBox="0 0 34 34"
        ...
        <aside className="w-1/3">
          ...
          <section className="blog-categories border-b pb-5 mt-10">
            <h1 className="py-5 text-xl font-semibold">Categories</h1>
            <ul className="blog-unordredlist w-[300px] space-y-2">
              <li>
                <a href="#">Articles</a> <span>(8)</span>
              </li>
              <li>
                <a href="#">Business</a> <span>(3)</span>
              </li>
              <li>
                <a href="#">Family & Divorce</a> <span>(4)</span>
              </li>
              <li>
                <a href="#">Web Design</a> <span>(2)</span>
              </li>
              <li>
          ...
          <div className="blog-tag py-6 flex flex-wrap border-b gap-2">
            {[
              "News",
              "Counseling",
              "Career",
